  ...
  module Composers
    class Onto
      def self.place!(component)
        ...
        children = soft_flatten(component.children, VP::Volatile)
...
=end
  ...
  class Component
    ...
    def initialize(*children, volatile_children: nil, bounds: quick_bounds, composer: Composers::Onto)
      @children = children
      @children << volatile_children if volatile_children
